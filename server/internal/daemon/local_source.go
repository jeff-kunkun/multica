...
func resolveTaskCodeSource(assignment *localDirectoryAssignment, readOnly []*localDirectoryAssignment, workDir string, repoURLs []string, remotesOf gitRemotesFunc) taskCodeSource {
	if assignment == nil {
