...
func (h *Handler) CreateProject(w http.ResponseWriter, r *http.Request) {
	...
	createParams := db.CreateProjectParams{
		...
		StartDate:   startDate,
		DueDate:     dueDate,
		// A human-created project starts private. An agent-created project has
		// no human creator column, so keeping it private would create an orphan
		// project that its owner cannot discover. Agent work starts workspace
		// visible; a human can narrow it later through the normal sharing flow.
