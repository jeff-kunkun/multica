-- Restore the validated pre-plan constraint. This intentionally fails closed
-- while plan-origin rows remain, because a rollback must not leave a trusted
-- constraint that existing rows violate.
